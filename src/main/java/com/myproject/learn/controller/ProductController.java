...
public class ProductController {
  ...
  ResponseEntity<?> getInfoProduct(@RequestParam String idProductType){
	  return new ResponseEntity<>(productService.getInfoProduct(idProductType), new HttpHeaders(), HttpStatus.OK);
  }
}
